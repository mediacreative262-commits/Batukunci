...
const BK_THEMES = {
  original: { label: 'Batu Kunci Original', desc: 'Akademik Eropa · collegiate · batu kunci', glyph: '◆' },
  horror: { label: 'Horror', desc: 'Gelap · crimson · gothic', glyph: '☾' },
  cool: { label: 'Cool', desc: 'Midnight · ice blue · tenang', glyph: '✦' },
  rich: { label: 'Rich', desc: 'Obsidian · champagne · premium', glyph: '◇' },
  genz: { label: 'Gen Z', desc: 'Indigo · pink · playful', glyph: '✷' },
  futuristic: { label: 'Futuristik', desc: 'Graphite · cyan · digital', glyph: '⌁' }
};
...
async function loadTeamForLogin() {
  try {
    ...
    // Tetap sinkronkan nama/foto/daftar anggota setelah login.
    if (!unsubUsers) {
