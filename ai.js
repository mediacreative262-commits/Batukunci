...
async function initAI(){
  try{
    ...
    // Gunakan Firebase app DEFAULT yang sudah diinisialisasi oleh app.js.
    // App Check juga sudah diaktifkan di app.js sebelum Auth/Firestore/AI.
    if(window.BK_APP_CHECK_READY !== true){
      throw new Error("Firebase App Check gagal diinisialisasi pada aplikasi utama.");
    }
    const aiApp=getApp();
